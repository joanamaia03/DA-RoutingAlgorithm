...
///This class is responsible for priority queues of pointers
template <class T>
...
public:
    ...
    ///Has the function of inserting a value into the pointer
    ///
    ///O(1) complexity.
	void insert(T * x);
    ///Has the function of extracting the smaller value from the pointer
    ///
    ///O(1) complexity.
	T * extractMin();
    ...
    ///Has the function of checking if the pointer is empty
    ///
    ///O(1) complexity.
	bool empty();
};
